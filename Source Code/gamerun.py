...
class Gamerun():
    def __init__(self, screen, screen_width, screen_height, clock):
        ...
        self.bg_image = pygame.image.load('../Infographics/bg1.png')
        ...
        #audio
        self.coin_sound = pygame.mixer.Sound('../Infographics/audio/coin.wav')
        self.coin_sound.set_volume(4)

        self.heart_sound = pygame.mixer.Sound('../Infographics/audio/heart.wav')
        self.heart_sound.set_volume(0.8)

        self.item_sound = pygame.mixer.Sound('../Infographics/audio/item_collect_sound.wav')
        self.item_sound.set_volume(1)

        self.die_sound = pygame.mixer.Sound('../Infographics/audio/die.wav')
        self.die_sound.set_volume(0.2)

        self.enemy_sound = pygame.mixer.Sound('../Infographics/audio/bullet.wav')
        self.enemy_sound.set_volume(0.2)

        self.bomb_stop_sound = pygame.mixer.Sound('../Infographics/audio/bomb_stop.wav')
        self.bomb_stop_sound.set_volume(0.5)

        self.explosion_sound = pygame.mixer.Sound('../Infographics/audio/explosion.wav')
    ...
    def display_skull(self):
        self.skull_bg1 = pygame.image.load('../Infographics/skull/skull_bg0.png').convert_alpha()
        ...
        self.skull_bg2 = pygame.image.load('../Infographics/skull/skull_bg0.png').convert_alpha()
        ...
        self.skull_bg3 = pygame.image.load('../Infographics/skull/skull_bg0.png').convert_alpha()
        ...
        if self.having_skull == 1:
            self.skull1 = pygame.image.load('../Infographics/skull/skull0.png').convert_alpha()
        ...
        if self.having_skull == 2:
            ...
            self.skull1_rect = self.skull1.get_rect(center=(50, self.screen_height - 35))
            self.screen.blit(self.skull1, self.skull1_rect)
            self.skull2 = pygame.image.load('../Infographics/skull/skull0.png').convert_alpha()
        ...
        if self.having_skull == 3:
            ...
            self.skull2_rect = self.skull2.get_rect(center=(100, self.screen_height - 35))
            self.screen.blit(self.skull2, self.skull2_rect)
            self.skull3 = pygame.image.load('../Infographics/skull/skull0.png').convert_alpha()
    ...
    def slow_strong_status(self):
        slow_image_status = pygame.image.load('../Infographics/slow/slow_status_color.png')
        slow_image_status_white = pygame.image.load('../Infographics/slow/slow_status_white.png')
        strong_image_status = pygame.image.load('../Infographics/strong/strong_status_color.png')
        strong_image_status_white = pygame.image.load('../Infographics/strong/strong_status_white.png')
