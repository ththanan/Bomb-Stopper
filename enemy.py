...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, pos, max_x, max_y, player_x, player_y, slow_status):
        super().__init__()
        run0 = pygame.image.load('assets/enemy/enemy0.png').convert_alpha()
        run1 = pygame.image.load('assets/enemy/enemy1.png').convert_alpha()
        run2 = pygame.image.load('assets/enemy/enemy2.png').convert_alpha()
        run3 = pygame.image.load('assets/enemy/enemy3.png').convert_alpha()
