...
class Player(pygame.sprite.Sprite):
    def __init__(self, max_x, max_y):
        super().__init__()
        idle0 = pygame.image.load('assets/player/player_idle0.png')
        idle1 = pygame.image.load('assets/player/player_idle1.png')
        idle2 = pygame.image.load('assets/player/player_idle2.png')
        idle3 = pygame.image.load('assets/player/player_idle3.png')
        idle4 = pygame.image.load('assets/player/player_idle4.png')
        idle5 = pygame.image.load('assets/player/player_idle5.png')
        idle6 = pygame.image.load('assets/player/player_idle6.png')
        idle7 = pygame.image.load('assets/player/player_idle7.png')
        self.idle = [idle0, idle1, idle2, idle3, idle4, idle5, idle6, idle7]

        run0 = pygame.image.load('assets/player/player0.png')
        run1 = pygame.image.load('assets/player/player1.png')
        run2 = pygame.image.load('assets/player/player2.png')
        run3 = pygame.image.load('assets/player/player3.png')
