...
font = pygame.font.Font('assets/mago3.ttf', 50)
scores = []
rankscores = []
show = 0

bg_music = pygame.mixer.Sound('assets/audio/Track 6 (Traffic Lights).wav')
bg_music.set_volume(0.3)
bg_music.play(loops=-1)

gamestart_sound = pygame.mixer.Sound('assets/audio/game_start.wav')
...
def menu():
    while True:
        ...
        prev_player_score = 0
        new_player_score = 0
        background_image = pygame.image.load('assets/bg1.png')
