...
class Slow(pygame.sprite.Sprite):
    def __init__(self, pos):
        ...
        idle0 = pygame.image.load('assets/slow/slow0.png').convert_alpha()
        idle1 = pygame.image.load('assets/slow/slow1.png').convert_alpha()
        idle2 = pygame.image.load('assets/slow/slow2.png').convert_alpha()
        idle3 = pygame.image.load('assets/slow/slow3.png').convert_alpha()
